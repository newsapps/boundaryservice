...
This project used to contain the complete boundary service code, however it now only contains the runnable demo. The boundary service itself is now available as a self-contained Django app.

See <a href="http://github.com/newsapps/django-boundaryservice">django-boundaryservice</a> for more details.
