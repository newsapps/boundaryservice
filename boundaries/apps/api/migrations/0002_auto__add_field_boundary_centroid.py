...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('api_boundary', 'centroid', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=4269, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Boundary.centroid'
        db.delete_column('api_boundary', 'centroid')
